...
function AboutPage(props) {
    ...
    return(
        <div>
            ...
            <Content>
              <p>Hello There! My name’s Travis and I’m currently twenty-three year old software developer, photographer, hiker, and weeb living in Portland, Oregon.</p>

              <p>For those of you who are reading this for hiring purposes, I’ll get my technical specifications out of the way first. I recently graduated from Lewis & Clark College with a degree in Computer Science and Mathematics, and I am a software developer by trade. I’m proficient in Python, Java, C, React, Flask, SQL, Linux/Unix, and Windows operating systems. I ahem two years of professional IT experience as well six years of general work experience which is all detailed in my resume, <a className="link" href="https://www.linkedin.com/in/travis-welch-004b63107/">LinkedIn</a>, and <a className="link" href="https://github.com/trav3711">Github</a>.</p>
